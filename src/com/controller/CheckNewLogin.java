...
/**
 * Servlet implementation class CheckNewLogin
 */
@WebServlet("/CheckNewLogin")
public class CheckNewLogin extends HttpServlet {
		...
		RequestDispatcher rDispatcher;
			...
			if(radioValue.equalsIgnoreCase("new"))
			{
				...
				if(flag==0)
				{
					...
					rDispatcher=request.getRequestDispatcher("newLogin.jsp");
