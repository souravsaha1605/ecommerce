   ...
   <table align="center" >
       ...
       <form method="post" action="CheckLogin">
          ...
          <td style='padding:5px 10px 5px 0px'>
           ...
           <td align="left" style='padding:5px 0px 10px 0px'>
             <input type="email" id="emailregister" name="email" placeholder="Enter email" autofocus required>
           </td>
       </tr>
       <tr>
       </tr>
       ...
       <tr>
           ...
           <td style='padding:20px 0px 0px 0px'>
              <input type="submit" value="Sign In" id="btnSumit">
           </td>
       </tr>
       </form>
    ...
    <script>
        ...
        function notrequiredpassword()
        {         
        	
            $("#passwordregister").prop("required","false");
        }
    </script>
