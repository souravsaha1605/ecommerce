...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3" >
            ...
            <a href="http://adimohinimohankanjilal.com/" ><center><img src="C:\Users\SOURAV SAHA\workspace\ECommerce\WebContent\images\9514291COD website banner2.jpg" title="Kanjivaram Saree" style="width: 160px;height: 230px;"></img></center></a>
 ...
 <input type="submit" value="ProceedCheckOut">
 </form>
 <form method="post" action="cookies3.jsp">
 
  
    
    <input type="hidden" name=name size=20 value="1001" class="smalltext">
    <input type="hidden" name=value size=20 value="Lahenga Saree"class="smalltext">
 ...
 // Checks for the value of name that it is null or not
  ...
  // redirects control to same page for new request
   response.sendRedirect("cookies3.jsp");
  }
